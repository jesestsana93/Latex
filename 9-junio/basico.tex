...
\usepackage{setspace}
%Los siguientes se aplican a todo el documento
%doublespacing
%onehalfspacing
%singlespace
%Que interlineado queremos \setstrech{2.5}

%Paquete que se usa para quitar numeracion a las lineas de texto
\usepackage[right]{lineno}
%\linenumbers
%Para alternar la numeracion en los libros(una pagina izquierdo y otro con numeracion 
%en la derecha) se usa \pagewiselinenumbers
%\modulolinenumbers[4]

%Paquete usado para ponerle marco a la pagina \usepackage{showframe}
...
%\usepackage[margin=2cm,rmargin=3cm,top=3cm,bottom=2cm,paperwidth=50cm,paperheight=90cm]{geometry}


%Especifica el tamaño de la fuente a usar en el documento
%\usepackage{scrextend}
%\changefontsizes{70pt}

\usepackage{anyfontsize}
\usepackage{color}

% Indentación en la primera linea
%\parindent=0mm
...
{\color {red}{\fontsize{70}{75}\selectfont Ejemplo de documento \LaTeX{}}} de la clase {\ttfamily article} con una estructura básica. 
...
%Nota al margen
\marginpar{En esta seccion revisamos algunos tipos de fuentes}
